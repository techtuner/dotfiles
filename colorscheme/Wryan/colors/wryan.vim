...
"  
"
"  Name: Wryan Theme for Neovim
"  Author: Santhosh Pai <techtuner284@gmail.com>
"  Site: https://github.com/techtuner/wryan-neovim
"  License: MIT
"
"
"  -------------------------------------------------------------------------
...
call s:GuiFor('DiffChange', 'NONE', s:green, 'italic')
call s:GuiFor('Label', 'NONE', s:green)
call s:GuiFor('MoreMsg', 'NONE', s:green)
call s:GuiFor('Title', 'NONE', s:green, 'bold')
...
" Vim Airline
" --------------------------------------------------
highlight NotifyERRORBorder guifg=s:red
highlight NotifyWARNBorder guifg=s:blue
highlight NotifyINFOBorder guifg=s:green
highlight NotifyDEBUGBorder guifg=s:grey_ui
highlight NotifyTRACEBorder guifg=s:purple
highlight NotifyERRORIcon guifg=s:red
highlight NotifyWARNIcon guifg=s:orange
highlight NotifyINFOIcon guifg=s:cyan
highlight NotifyDEBUGIcon guifg=s:grey_ui
highlight NotifyTRACEIcon guifg=s:violet
highlight NotifyERRORTitle  guifg=s:red
highlight NotifyWARNTitle guifg=s:orange
highlight NotifyINFOTitle guifg=s:green
highlight NotifyDEBUGTitle  guifg=s:grey
highlight NotifyTRACETitle  guifg=s:magenta
