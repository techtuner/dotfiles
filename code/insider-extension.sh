# -----------------------------------------------------------------------------
#
# Script to install all extension in VSCode
#
# -----------------------------------------------------------------------------
...
code-insiders --install-extension catppuccin.catppuccin-vsc
...
code-insiders --install-extension pkief.material-product-icons
